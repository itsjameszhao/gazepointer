    ...
    if results.multi_face_landmarks:
        for idx, lm in enumerate(results.multi_face_landmarks[0].landmark):
            ...
            if idx == 1:
                ...
                nose_3d = (lm.x * img_w, lm.y * img_h, lm.z * 10000)
        ...
        success, rotation_vec, translation_vec = cv2.solvePnP(
            face_3d, face_2d, cam_matrix, distortion_matrix, cv2.SOLVEPNP_ITERATIVE
        )
        ...
        x_pix, y_pix = map_yaw_pitch_to_xy([-6, 6, -1, 6], [0, 1920, 1080, 0], y, x)
