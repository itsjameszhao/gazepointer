...
from gazepointer.dat_message import Data


class GazePointerModule(ABC):
  """A module to be used in our image processing pipeline"""

   def __init__(self, input_queue: Optional[queue.Queue] = None, output_queue: Optional[queue.Queue] = None) -> None:
    ...
    def _run(self) -> None:
        ...
        while not self.stop_event.is_set():
            try:
                data: Optional[data] = self.input_queue.get(
